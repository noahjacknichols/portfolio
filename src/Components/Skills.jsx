                ...
                <Container>
                  ...
                  <div className="skillContainer" style={props}>
                    <Row className="skillContainer">
                      <Col xs={12}>
                        <div className="white header">Things I Excel At</div>
                      </Col>
                    </Row>
                    <Row className="skillContainer skillFooter">
                      <Col sm={12} md={4}>
                        <Spring
                          config={{
                            duration: 700,
                            delay: isVisible ? 600 : 100,
                          }}
                          from={{ opacity: 0 }}
                          to={{ opacity: isVisible ? 1 : 0 }}
                        >
                          {(props) => (
                            <div className="langs" style={props}>
                              I work with:
                            </div>
                          )}
                        </Spring>
                      ...
                      <Spring
                        config={{ duration: 700, delay: isVisible ? 600 : 100 }}
                        from={{ opacity: 0 }}
                        to={{ opacity: isVisible ? 1 : 0 }}
                      >
                        {(props) => (
                          <div
                            className="d-none d-md-block dashed"
                            style={props}
                          ></div>
                        )}
                      </Spring>
                      <Col className="quoteCtn" s={12} md={7}>
                        <div className="quoteSubCtn">
                          ...
                          >
                            {(props) => (
                              <div
                                className="d-none d-md-block quoteTop"
                                style={props}
                              >
                                “
                              </div>
                          ...
                          >
                            {(props) => (
                              <div
                                className="white langs quoteText"
                                style={props}
                              >
                                Over the course of my career, I have developed
                                skills in a wide range of languages. My goal is
                                to broaden my skillset and knowledge every day.{" "}
                              </div>
                            )}
                          </Spring>
                          <Spring
                          ...
                          >
                            {(props) => (
                              <div
                                className="d-none d-md-block quoteBottom quoteBottomCtn"
                                style={props}
                              >
                                ”
                              </div>
